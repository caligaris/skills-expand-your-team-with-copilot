document.addEventListener("DOMContentLoaded", () => {
  ...
  function renderActivityCard(name, details) {
      ...
      <div class="activity-card-actions">
        ...
        <div class="share-section">
          ...
          <div class="share-buttons">
            <a class="share-btn share-whatsapp tooltip" href="#" data-activity="${name}" aria-label="Share on WhatsApp">
            ...
            <a class="share-btn share-twitter tooltip" href="#" data-activity="${name}" aria-label="Share on X (Twitter)">
              <svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.737-8.835L1.254 2.25H8.08l4.259 5.631zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
              <span class="tooltip-text">Share on X</span>
            </a>
            <button class="share-btn share-copy tooltip" data-activity="${name}" aria-label="Copy link">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" xmlns="http://www.w3.org/2000/svg"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 01-2-2V4a2 2 0 012-2h9a2 2 0 012 2v1"></path></svg>
    ...
    activityCard.querySelector(".share-copy").addEventListener("click", async (e) => {
      ...
      setTimeout(() => { tooltipText.textContent = "Copy link"; }, 2000);
    });
